...
public interface VideoDao extends BaseDBDao<VideoPo> {
    ...
    public List<VideoPo> getChannelItemsAsc(@Param("channel")String channel,@Param("keyword")String keyword,@Param("channelType")String channelType, @Param("baseurl")String baseurl);
    public List<VideoUserPo> getUsers(@Param("channel")String channel, @Param("keyword")String keyword);
