...
public class BytedanceAsrClient extends WebSocketClient {
    ...
    public static BytedanceAsrClient build() throws URISyntaxException {
        URI uri = new URI(URL);
        return new BytedanceAsrClient(uri);
    }

    // TODO 接受一个 listener 监听消息, onOpen, onMessage, onError, onComplete
    private BytedanceAsrClient(URI uri) {
        super(uri);
    }
