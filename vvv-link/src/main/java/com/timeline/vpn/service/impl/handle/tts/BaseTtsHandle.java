 ...
 */
public abstract class BaseTtsHandle implements BaseSupportHandle<Integer> {
    protected static final Logger LOGGER =
            LoggerFactory.getLogger(BaseTtsHandle.class);
    ...
    public abstract String textToSSML(String text) throws UnsupportedEncodingException;
    public abstract TtsResponseVo textToVideo(BaseQuery baseQuery, AsrContentForm chatContentForm) throws Exception;
    @Override
