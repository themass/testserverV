...
public class DeviceUtil {
    ...
    private static final String VPNVERSION = "(VVV|VVVB|LIFE|SEX|SEX_TEMP|NETHELP)/(([0-9]+)\\.([0-9]+)\\.([0-9]+)\\.([0-9]+))";
