...
public class JacksonJsonUtil {
    ...
    public static <T> Map<String, T> readMapValue(String info, Class<T> t) {
        if (info == null || info.isEmpty()) {
            return new HashMap<>();
        }
        try {
            return getMapper().readValue(info, getMapType(t));
        } catch (Exception e) {
            LOGGER.error("json util error:" + info + "->" + t.getName(), e);
            return null;
        }
    ...
    public static <T> List<T> readListValue(String info, Class<T> t) {
        if (info == null || info.isEmpty()) {
            return new ArrayList<>();
        }
        try {
            return getMapper().readValue(info, getListType(t));
        } catch (Exception e) {
            LOGGER.error("json util error:" + info + "->" + t.getName(), e);
            return null;
        }
    ...
    public static <T> T readValue(String info, JavaType type) {
        try {
            ...
            LOGGER.error("json util error:" + info + "->" + type.toString(), e);
            return null;
        }
    }
    ...
    public static String toJsonStr(Object o) {
        try {
            ...
            LOGGER.error("json util error:" + o, e);
            return null;
        }
    }
