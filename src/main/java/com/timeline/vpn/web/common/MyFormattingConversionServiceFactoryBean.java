 ...
 * @Description: 无法继承FormattingConversionServiceFactoryBean，因为很多方法是private的或者没有get的
 * @author gqli
 * @date 2016年11月3日 下午9:29:04
 *
 */
public class MyFormattingConversionServiceFactoryBean implements
        FactoryBean<FormattingConversionService>, EmbeddedValueResolverAware, InitializingBean {
